...
def get_word_score(word, n):
    ...
    # work out the first part of the score
    if word == '':
        return 0
    for letters in word:
        first_score_component += SCRABBLE_LETTER_VALUES[letters]
    # work out the second part of the score
